...
class DescontosWidget extends StatelessWidget {
  final List<Desconto> descontos = [
    Desconto(
      ...
      img:
          'https://secompufscar.com.br/uploads/logo_patrocinadores/yo_colorida.png',
    ),
    Desconto(
      loja: 'Japa Açaí',
      ...
      obs: '(com apresentação do crachá)',
      img:
          'https://secompufscar.com.br/uploads/logo_patrocinadores/japa_colorida.png',
    ),
    Desconto(
      ...
      obs: '(com apresentação do crachá)',
      img:
          'https://secompufscar.com.br/uploads/logo_patrocinadores/dogrego_colorida.png',
    ),
    Desconto(
    ...
    Desconto(
      ...
      img:
          'https://secompufscar.com.br/uploads/logo_patrocinadores/macarronato_colorida.png',
    ),
    Desconto(
      loja: 'Rock Burger',
      ...
      obs: '(com apresentação do crachá)',
      img:
          'https://secompufscar.com.br/uploads/logo_patrocinadores/rockburger_colorida.png',
    ),
    Desconto(
      loja: "Billy's BBQ",
      ...
      img:
          'https://scontent-gru2-1.xx.fbcdn.net/v/t1.0-9/48420527_316167365665638_5593552006565330944_n.jpg?_nc_cat=102&_nc_oc=AQnhRtccsZYTyUoTxtaXeYeBsGpquYF20rU_EGsp0yteMeSRyjZJIROqEWuf-7rg2tA&_nc_ht=scontent-gru2-1.xx&oh=38b7072a728ba9bbaa90cbbc7c4147e2&oe=5DF05B00',
    ),
    Desconto(
      loja: 'Estação da luz',
      ...
      obs: '(com apresentação do crachá)',
      img:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFwGtcjdoeXgdGB0nI03z9PonOd3NYC1EgTqCJZ-gY0BSMTrV4',
    ),
    Desconto(
